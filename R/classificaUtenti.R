...
#' vocabolario_nomi_propri assegna il genere e \code{data(vocabolario_luoghi)}
#' l'area geografica (vedi esempio)
#' 
#' 
#' Per il \code{data(vocabolario_luoghi)} abbiamo escluso i paesi Re (800
...
#' 
#' @aliases classificaUtenti vocabolario_nomi_propri vocabolario_luoghi
...
#' e' \code{data(vocabolario_nomi_propri)}. ATTENZIONE, nel \code{vocabolario}
...
#' \code{vocabolario=vocabolario_nomi_propri} le modalita' sono
#' \code{c('masc','femm','ente')}.
#' @author Mattia Uttini, Livio Finos, Andrea Mamprin, Dario Solari
#' @keywords ~kwd1 ~kwd2
#' @examples
#' 
#' \dontrun{data(vocabolario_nomi_propri)}
#' \dontrun{str(vocabolario_nomi_propri)}
#' classificaUtenti(c('livio','alessandra','alessandraRossi', 'mariobianchi'), scan_interno=TRUE)
#' \dontrun{data(vocabolario_luoghi)}
#' classificaUtenti(c('Bosa','Pordenone, Italy'), vocabolario_luoghi)
#' 
